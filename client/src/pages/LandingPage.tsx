...
.hero-stat-lbl {
  ...
  margin-top: 4px; font-weight: 500;
        ...
        /* ── HOW IT WORKS ── */
        .how-section { background: var(--dark2); border-top: 1px solid var(--border); border-bottom: 1px solid var(--border); }
        ...
        .pricing-badge {
          ...
          background: var(--indigo); border-radius: 100px;
        ...
        .pricing-btn-filled:hover { background: var(--indigo-dark); box-shadow: 0 8px 28px rgba(99,102,241,0.5); transform: translateY(-1px); }
        ...
        .cta-bg {
          position: absolute; inset: 0; z-index: 0;
          background: radial-gradient(ellipse 60% 60% at 50% 50%, rgba(99,102,241,0.15) 0%, transparent 70%);
        }
        .cta-title {
          font-family: 'Syne', sans-serif;
        ...
        <div className="section-inner">
          ...
          <div className="pricing-grid">
            ...
            <div className="pricing-card">
              ...
              <div className="pricing-price">Ücretsiz<span></span></div>
            ...
            <div className="pricing-card">
              ...
              <div className="pricing-price">Özel<span></span></div>
